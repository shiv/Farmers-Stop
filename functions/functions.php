...
function getUserIP(){
	switch (true){
		...
		case(!empty($_SERVER['HTTP__X_FORWARDED_FOR'])) : return $_SERVER['HTTP__X_FORWARDED_FOR'];
...
/*Get Product-Categories items (jackets ,shoes, accessories, etc)*/
function getPcatPro(){
	global $db;
...
/*Get Categories items(Men, Women, Kids, Others)*/
function getCatPro(){
	global $db;
