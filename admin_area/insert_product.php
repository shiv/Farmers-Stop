...
<div class="row">
	...
	<div class="col-lg-3"></div><!--this is just blank div for spacing from left side-->
	...
	<div class="col-lg-3"><!--this is just blank div for spacing from right side-->
...
if (isset($_POST['submit'])) {
	...
	values('$product_cat','$categories',NOW(),'$product_title','$product_img1','$product_img2','$product_img3','$product_price','$product_desc','$product_keywords')";
